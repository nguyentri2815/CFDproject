document.addEventListener("DOMContentLoaded",function(){
    ...
    const clickTab={
        ...
        clickname:function(){
            let elementTab=document.querySelectorAll('.member-content__left a');
            let elementContent=document.querySelectorAll('.member-content__right-item');
            elementTab.forEach(element => {
                element.addEventListener('click',function(e){
                    e.preventDefault();
                    for (let index = 0; index < elementTab.length; index++) {
                       elementTab[index].classList.remove('active');
                       elementContent[index].classList.remove('active')
                    }
                    this.classList.add('active');
                    let nameID =this.getAttribute('data-content');
